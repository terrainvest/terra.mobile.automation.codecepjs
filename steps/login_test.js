...
Scenario('login with wrong password',  ({ I }) => {
    login.doLogin('43622593091', 'Terra@12345')
...
Scenario('login with Registration in analysis',  ({ I }) => {
    login.doLoginwithoutuser('36158068160')
    login.validateRegistrationanalisys()
});

Scenario('login with Registration blocked',  ({ I }) => {
    login.doLogin('03981728629', 'Terra@12345')
    login.validateRegistrationblocked()
});

Scenario('login with Registration document pendency',  ({ I }) => {
    login.doLoginwithoutuser('70111924090')
    login.validateRegistrationpendency()
});
